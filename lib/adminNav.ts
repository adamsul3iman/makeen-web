...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/shifts", label: "الورديات", icon: History },
    ],
  },
  {
    id: "inventory",
    ...
    items: [
      { href: "/admin/inventory/focus", label: "وضع التركيز (المستودع)", icon: ScanLine },
...
export const PAGE_TITLES: Record<string, string> = {
  ...
  "/admin/catalog-excel": "استيراد وتصدير إكسل",
