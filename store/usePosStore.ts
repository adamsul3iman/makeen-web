        ...
        for (const r of rows) {
          ...
          items = addLine(
            items,
            {
              ...
              qty: baseQty,
              discount: 0,
              taxPercent: r.taxPercent ?? state.products[r.productId]?.taxPercent ?? effectiveTaxPercent(state.currentStore),
              taxIncluded: r.taxIncluded ?? state.products[r.productId]?.taxIncluded ?? false,
              unitName: r.unitName,
